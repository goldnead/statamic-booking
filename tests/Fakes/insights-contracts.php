 ...
 * where a test asked for it, which is the same trade `insights-facade.php` and
 * `insights-table-metric.php` make beside it, and for the same reason.
 *
 ...
 *
 * **Load this before `insights-table-metric.php`.** The base class the metrics
 * extend implements `Metric`, so the interface has to exist by the time PHP
 * reads it.
 *
