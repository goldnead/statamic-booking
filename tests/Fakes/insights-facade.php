 ...
 *
 * The `$root` is set by the test to a collector that records what the provider
 * offers. Stricter than the real manager on purpose — see
 * `InsightsMetricsTest::setUp()`.
 *
